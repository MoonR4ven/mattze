      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
            ...
            <Card className="border-2 hover:border-[rgb(var(--mavi-turquoise))]/30 hover:shadow-md transition-all cursor-pointer bg-slate-100">
              <CardContent className="p-2.5 text-center">
        ...
        {filteredCustomers.length === 0 && (
          <Card className="border-2 border-dashed border-border bg-slate-100">
